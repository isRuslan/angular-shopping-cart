"use strict";
/**
 * Welcome to the Store module
 */

angular.module('MyStore.store', [])
...
.controller('StoreCtrl', ['$scope', 'Store', 'Cart', '$stateParams', function ($scope, Store, Cart, $stateParams) { 
